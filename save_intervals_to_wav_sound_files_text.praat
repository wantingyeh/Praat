...
form Save intervals to small sound files
	...
	sentence Folder D:\UoA\04research\00temp\text_seg\
	comment Give an optional prefix for all filenames:
	sentence Prefix DIME058_CV_P-
...
for interval from start_from to end_at
	...
	if check = 0
		...
		select TextGrid 'soundname$'
		Extract part... intervalstart intervalend no
		outputfiletext$ = "'folder$'" + "'prefix$'" + "'intnumber'" + "'suffix$'" + ".TextGrid"
		Save as text file... 'outputfiletext$'
